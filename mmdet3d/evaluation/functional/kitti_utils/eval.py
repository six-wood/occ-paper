...
def do_coco_style_eval(gt_annos, dt_annos, current_classes, overlap_ranges, compute_aos):
    ...
    mAP_bbox, mAP_bev, mAP_3d, mAP_aos, _, _, _, _ = do_eval(gt_annos, dt_annos, current_classes, min_overlaps, compute_aos)
