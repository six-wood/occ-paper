...
class PackSscInputs(BaseTransform):
    ...
    SEG_KEYS = ["gt_seg_map", "pts_instance_mask", "pts_semantic_mask", "gt_semantic_seg", "voxel_label"]
        ...
        for key in self.keys:
            if key in results:
                if key in self.INPUTS_KEYS:
                    ...
                    raise NotImplementedError(f"Please modified " f"`Pack3DDetInputs` " f"to put {key} to " f"corresponding field")
