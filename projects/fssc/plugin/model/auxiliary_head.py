...
class PtsAuxHead(Base3DDecodeHead):
    ...
    def _stack_batch_gt(self, batch_data_samples: SampleList) -> Tensor:
        ...
        gt_semantic_segs = [data_sample.gt_pts_seg.voxel_semantic_mask for data_sample in batch_data_samples]
    ...
    def predict(self, inputs: Tensor, batch_data_samples: SampleList) -> List[Tensor]:
        ...
        batch_idx = torch.cat([data_samples.batch_idx for data_samples in batch_data_samples])
        seg_logit_list = []
