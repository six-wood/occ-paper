...
class RangeHead(Base3DDecodeHead):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RangeHead, self).__init__(**kwargs)
    ...
    def loss_by_feat(self, seg_logit: Tensor, batch_data_samples: SampleList) -> dict:
    ...
    def predict(self, inputs: Tuple[Tensor], proj_xs: List[Tensor], proj_ys: List[Tensor], test_cfg: ConfigType = None) -> torch.Tensor:
