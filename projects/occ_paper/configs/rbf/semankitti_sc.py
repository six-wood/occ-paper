...
from projects.occ_paper.occ_paper.semantickitti_dataset import SemanticKittiSC as dataset_type
...
train_pipeline = [
    ...
    dict(type=LoadVoxelLabelFromFile, grid_size=grid_size, scale=scale),
    dict(type=SemkittiRangeView),
    dict(type=ApplayVisMask),
    dict(
        type=PackOccInputs,
        keys=["points", "voxel_label", "range_img"],
        meta_keys=("proj_x", "proj_y"),
    ),
]
